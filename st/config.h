 ...
 */
//static char font[] = "Inconsolata:size=10:pixelsize=9:antialias=true:autohint=true";
//static char font[] = "Inconsolata:pixelsize=9:antialias=true:autohint=true";
...
static const char *colorname[] = {
	...
	//"#dcdccc", // 258 - cursor color
	//"#dcdccc", // 259 - reverse cursor color
};
